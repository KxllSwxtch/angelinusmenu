...
export const menuData = [
	{
		...
		items: [
...

			{
				...
				description:
					'Нежный крем-суп на сливочной основе с шампиньонами, картофелем, луком и морковью.',
				image:
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				description: '',
				image:
					'https://bakinskiibulvar.ru/wp-content/uploads/2020/06/kolbasnoe-assorti.jpg',
