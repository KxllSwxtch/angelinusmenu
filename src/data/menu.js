		...
		items: [
			{
				name: 'Кавказский',
				description:
					'Изысканное ассорти из копченых колбас, выдержанных сыров и отборных орехов с добавлением сладких сухофруктов.',
				image: 'https://kostis.ru/f/product/offer/head_1__959.jpg',
			},
			{
				name: 'Погребок',
				description:
					'Домашняя нарезка из фермерских колбас, мягких сыров и свежеобжаренных орехов, украшенная медовыми сухофруктами.',
