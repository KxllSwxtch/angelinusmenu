		...
		items: [
			{
				name: 'Кавказский',
				description:
					'Ассорти из колбас, сыров, орехов и сухофруктов, приготовленный по традиционному рецепту.',
				image: 'https://kostis.ru/f/product/offer/head_1__959.jpg',
			},
			{
				name: 'Погребок',
				description:
					'Погребок из колбас, сыров, орехов и сухофруктов, приготовленный по традиционному рецепту.',
			...
			},
			{
				name: 'Фруктовое',
				description:
					'Фруктовый ассорти из сухофруктов, приготовленный по традиционному рецепту.',
